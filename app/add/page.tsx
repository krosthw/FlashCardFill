  ...
  return (
    ...
    <main className="flex  flex-col items-center justify-between p-6">
      ...
      <form className="max-w-sm mx-auto">
        <div className="mb-5">
          <label htmlFor="latoA" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">4lato</label>
          <input type="text" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required/>
        </div>
        <div className="mb-5">
          <label htmlFor="latoB" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">latoB</label>
        ...
        <div className="mb-5">
          <label htmlFor="pron" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">pron</label>
